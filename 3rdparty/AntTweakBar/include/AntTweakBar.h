...
TW_API int TW_GLUT_CALL TwEventMouseWheelGLUT(int glutWheel, int direction, int x, int y);
...
typedef void (TW_GLUT_CALL *GLUTmousewheelfun)(int glutWheel, int direction, int x, int y);
